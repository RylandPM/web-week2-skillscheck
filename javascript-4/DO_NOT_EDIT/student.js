...
// CODE HERE
let faveColors = ["red", "black", "silver"];
...
// CODE HERE
let me = {
  firstName: "Ryland McGee",
  superHeroName: "Dragon Man",
  homeTown: "Wexford, PA",
  superPowers: [
    "way to much strength for a sorceror",
    "a party full of sidekicks",
    "a metric shit ton of additional fire damage modifiers"
  ],
