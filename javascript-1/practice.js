...
// Code Here
let total = myNumbers.reduce(function(acc, x) {
  return acc + x;
});
...
// Code Here
let myNumbersIndex = [];
myNumbers.forEach(function(x, i) {
...
// Code Here
let forTheLoveOfGeorge = notGeorge.map(x => "George");
...
// Code Here
let totallyAwesome = people.reduce(function(acc, person) {
